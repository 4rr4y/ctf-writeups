# Reversing - The Javascript One (Tenable CTF 2023)

## Problem

We are given obfuscated Javascript to reverse:
...
We first put it through [https://obf-io.deobfuscate.io/](https://obf-io.deobfuscate.io/), and combine it with a manual cleanup effort to obtain the following:

```js
// ----- GROUP 1 -----

(function (_0x25abc1, _0x1b11ab) {
  var _0x15cf55 = _0x25abc1();
  while (true) {
    try {
      var _0x187219 = parseInt(_0x3cdb(458)) / 1 * (parseInt(_0x3cdb(404)) / 2) + -parseInt(_0x3cdb(450)) / 3 * (-parseInt(_0x3cdb(422)) / 4) + parseInt(_0x3cdb(429)) / 5 + parseInt(_0x3cdb(418)) / 6 + parseInt(_0x3cdb(457)) / 7 + parseInt(_0x3cdb(423)) / 8 * (-parseInt(_0x3cdb(439)) / 9) + -parseInt(_0x3cdb(459)) / 10;
      if (_0x187219 === _0x1b11ab) {
        break;
      } else {
...
function _0x3cdb(_0x381052, _0x232c3a) {
  ...
  _0x3cdb = function (_0x21facc, _0x5b9257) {
    _0x21facc = _0x21facc - 381;
    var _0x56da0f = _0x5b708f[_0x21facc];
    return _0x56da0f;
  };
  return _0x3cdb(_0x381052, _0x232c3a);
}
...
function _0x2a8b() {
    var _0x2d270d = [_0x5114[5], _0x5114[6], _0x5114[7], _0x5114[8], _0x5114[9], _0x5114[10], _0x5114[11], _0x5114[12], _0x5114[13], _0x5114[14], _0x5114[15], _0x5114[16], _0x5114[17], _0x5114[18], _0x5114[19], _0x5114[20], _0x5114[21]];
    _0x2a8b = function () {
      return _0x2d270d;
    };
    return _0x2a8b();
...
function _0x3e24(_0x56ccee, _0x54f27c) {
  var _0x5388f8 = _0x2a8b();
  _0x3e24 = function (_0x42bf11, _0x12aaa8) {
    _0x42bf11 = _0x42bf11 - 265;
    var _0x4805b5 = _0x5388f8[_0x42bf11];
    return _0x4805b5;
  };
  return _0x3e24(_0x56ccee, _0x54f27c);
}
...
var flag = _0x3e24(266);

function validateFlag(_0x1dd864) {
  var _0x4269fd = _0x3e24(273);
  return _0x4269fd === _0x3e24(273);
}
function reverseFlag(_0x5aa062) {
  return _0x5aa062[_0x3e24(267)](_0x5114[2])[_0x3e24(278)]()[_0x3e24(274)](_0x5114[2]);
}
...
console[_0x5114[22]](flag);
```

Note that `Group 1` and `Group 2` simply help store offsets to string in the Javascript. By executing the required functions in each group (browser Console suffices) the values for `_0x3e24(index)` can be eventually obtained. The final de-obfuscated javascript looks as follows:

```js
// ----- GROUP 1 -----

_0x3cdb = [ "FFiHo", "fQYsf", "PSMEK", "fHNjI2NgaA", "log", "3333978wBY", "fdNFC", "paKiw", "shift", "6nMpKMt", … ]
  
// ----- GROUP 2 -----

_0x3e24 = [ "2681065VjgJlj", "Zm1jZH92N2tkcFVhbXs6fHNjI2NgaA==", "split", "3IoFoig", "310080UgNxMY", "2282352jiOaqE", "fromCharCode", "3333978wBYWRq", "Not implemented.", "join", "236046XdgOCv", "6nMpKMt", "48517AjJpRI", "reverse", "424erSbWD", "50VJNKtb", "2285525hAxmKB"]
...
function encryptFlag(v) {
  var result = "";
  for (var i = 0; i < v["length"]; i++) {
    result += String["fromCharCode"](v["charCodeAt"](i) ^ i);
  }
  return btoa(result);
}
function decryptFlag(v) {
...
We find from the above code that when encrypting the flag, each character is XOR-ed with its index. Reversing this procedure via a Python script gives us the final flag:

```python
import base64

enc_flag_b64 = 'Zm1jZH92N2tkcFVhbXs6fHNjI2NgaA=='
enc_flag = base64.b64decode(enc_flag_b64)
flag = ''
for i in range(len(enc_flag)):
    flag += chr(enc_flag[i] ^ i)
print(flag)
```
